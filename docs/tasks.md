...
Acceptance Criteria:
- Project, Feedback Cycle, Feedback Card, Cluster, Vote, and Action Item exist as models with their relationships (e.g. a cycle belongs to a project, a card belongs to a cycle)
...
- The facilitator can add team members to the cycle
...
Acceptance Criteria:
- The facilitator can upload audio, video, a transcript file, or paste transcript text against a completed cycle
